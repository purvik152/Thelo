        ...
        {icons.map((icon, index) => (
          <div
            ...
            className={`absolute transition-opacity duration-500 ${
              index === currentIndex ? 'opacity-100 animate-fade-in-out' : 'opacity-0'
            }`}
          >
            {icon}
          </div>
        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          <Link href="/" className="flex items-center space-x-2">
            <span className="font-bold text-lg">
              <div>
                <img src="/FinalLogo-withoutBG.png" className="max-h-16" alt="Thelo" />
              </div>
            </span>
          </Link>
        ...
        <section className="py-20 md:py-32 bg-[#FBF3E5]/95">
          <div className="container mx-auto text-center px-4 md:px-6">
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl text-gray-600">
              The definitive B2B marketplace for India's finest raw food materials. We bridge the gap
              between producers and businesses, ensuring quality, transparency, and growth.
            </p>
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Button
                size="lg"
                className="h-12 px-8 text-base bg-[#BEA093] hover:bg-[#FBF3E5] hover:text-[#BEA093]"
                asChild
              >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="mt-3 text-lg text-muted-foreground">
              Find exactly what you need from our wide range of raw materials.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {categories.map((cat) => (
              <div
                key={cat.name}
                className="p-6 rounded-xl border bg-card text-card-foreground text-center hover:shadow-lg transition-shadow"
              >
                <div
                  className={`mx-auto flex h-16 w-16 items-center justify-center rounded-full ${cat.color} mb-5`}
                >
                  {cat.icon}
                </div>
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="mt-20 relative grid md:grid-cols-3 gap-y-16 md:gap-x-16">
            ...
            <div className="relative flex flex-col items-center">
              <div className="flex items-center justify-center h-20 w-20 rounded-full bg-green-100 text-green-600 mb-6 border-4 border-background">
              ...
              <p className="mt-3 text-muted-foreground max-w-xs">
                Sellers showcase their raw materials, complete with details, pricing, and quality
                standards.
              </p>
            </div>
            <div className="relative flex flex-col items-center">
              <div className="flex items-center justify-center h-20 w-20 rounded-full bg-blue-100 text-blue-600 mb-6 border-4 border-background">
                <Search className="h-10 w-10" />
              </div>
              <h3 className="text-2xl font-semibold">2. Shopkeepers Discover</h3>
              <p className="mt-3 text-muted-foreground max-w-xs">
                Shopkeepers easily search, filter, and find the exact ingredients they need for their
                business.
              </p>
            </div>
            <div className="relative flex flex-col items-center">
              <div className="flex items-center justify-center h-20 w-20 rounded-full bg-orange-100 text-orange-600 mb-6 border-4 border-background">
                <Handshake className="h-10 w-10" />
              </div>
              <h3 className="text-2xl font-semibold">3. Goods are Transacted</h3>
              <p className="mt-3 text-muted-foreground max-w-xs">
                Secure orders are placed, payments are processed, and goods are delivered efficiently.
              </p>
            </div>
          </div>
        </div>
