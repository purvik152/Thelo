...
function CreateProfileView({ onProfileCreated }: CreateProfileViewProps) {
    ...
    <div className="w-full max-w-2xl mx-auto py-12">
      <Card>
        <CardHeader>
          ...
          <CardDescription>This information is required before you can add products.</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Input
                  id="brandName"
                  name="brandName"
                  placeholder="e.g., Acme Fresh Goods"
                  className="bg-[#FDFBF4]"
                  required
                />
              </div>
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="123 Business Rd, Business City"
                  className="bg-[#FDFBF4]"
                  required
                />
              </div>
      ...
      <>
        ...
        <div className="hidden md:block rounded-lg border bg-card">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="w-[80px] bg-[#BEA093] border rounded-tl-lg">Image</TableHead>
                <TableHead className="bg-[#BEA093] border">Product Name</TableHead>
                <TableHead className="bg-[#BEA093] border">Status</TableHead>
                <TableHead className="text-right bg-[#BEA093] border">Price</TableHead>
                <TableHead className="text-right bg-[#BEA093] border">Stock</TableHead>
                <TableHead className="w-[50px] bg-[#BEA093] border rounded-tr-lg">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
                ...
                <TableRow key={product._id}>
                  <TableCell>
                    <div className="relative h-16 w-16 rounded-md overflow-hidden">
                      <Image
                        src={product.imageUrl || "https://placehold.co/64x64/eee/ccc?text=No+Image"}
                        alt={product.name}
                        fill
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-[#FBF3E5]">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem className="text-red-600" onClick={() => handleOpenAlert(product)}>
        ...
        {/* Card grid for small screens (sm and below) */}
              ...
              <CardContent className="p-4 flex flex-col justify-between h-full">
                <div className="flex gap-4">
                  <div className="relative h-20 w-20 flex-shrink-0 rounded-md overflow-hidden">
                    <Image
                      src={product.imageUrl || "https://placehold.co/80x80/eee/ccc?text=No+Image"}
                      alt={product.name}
                      fill
                      className="object-cover"
                    />
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem
                            ...
                            onClick={() => handleOpenAlert(product)}
                          >
                            <Trash2 className="mr-2 h-4 w-4" /> Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
  ...
  return (
    <>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2">
                ...
                <Input
                  ...
                  className="sm:col-span-3 bg-[#FDFBF4]"
                  required
                />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2">
                ...
                <select
                  ...
                  className="sm:col-span-3 flex h-10 w-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                >
                  <option value="Active" className="bg-[#FBF3E5]">
                    Active
                  </option>
                  <option value="Archived" className="bg-[#FBF3E5]">
                    Archived
                  </option>
                </select>
              </div>
      ...
      <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
        <AlertDialogContent className="bg-[#FBF3E5]">
          <AlertDialogHeader>
  ...
  return (
    <div className="w-full py-8 px-4 sm:px-6 lg:px-8">
      {profileExists ? (
        ...
        <CreateProfileView onProfileCreated={checkProfile} />
      )}
    </div>
  );
}
