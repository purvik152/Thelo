                ...
                <DialogContent className="sm:max-w-lg">
                    ...
                    <form onSubmit={handleSaveProduct}>
                        <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2"><Label htmlFor="name" className="sm:text-right">Name</Label><Input id="name" name="name" defaultValue={productToEdit?.name} className="sm:col-span-3" required /></div>
                            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2"><Label htmlFor="description" className="sm:text-right">Description</Label><Textarea id="description" name="description" defaultValue={productToEdit?.description} className="sm:col-span-3" required /></div>
                            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2"><Label htmlFor="category" className="sm:text-right">Category</Label><Input id="category" name="category" defaultValue={productToEdit?.category} className="sm:col-span-3" placeholder="e.g., Grains, Spices" required /></div>
                            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2"><Label htmlFor="price" className="sm:text-right">Price (₹)</Label><Input id="price" name="price" type="number" defaultValue={productToEdit?.price} className="sm:col-span-3" required /></div>
                            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2"><Label htmlFor="stock" className="sm:text-right">Stock</Label><Input id="stock" name="stock" type="number" defaultValue={productToEdit?.stock} className="sm:col-span-3" required /></div>
                            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2"><Label htmlFor="location" className="sm:text-right">Location</Label><Input id="location" name="location" defaultValue={productToEdit?.location} className="sm:col-span-3" placeholder="e.g., Nashik, Maharashtra" required /></div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-x-4 gap-y-2"><Label htmlFor="image" className="sm:text-right">Image</Label><Input id="image" name="image" type="file" className="sm:col-span-3" accept="image/*" /></div>
                        </div>
